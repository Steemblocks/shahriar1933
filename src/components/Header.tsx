    ...
    return (
        <>
            ...
            >
                {/* Menu Container */}
                <div
                    className={`absolute right-0 top-0 w-full xs:w-80 h-full bg-gradient-to-br from-[#0a0a12] via-[#0d0d18] to-[#050508] transform transition-transform duration-500 ease-out shadow-2xl border-l border-white/10 ${isMenuOpen ? "translate-x-0" : "translate-x-full"
                        }`}
                >
                    {/* Decorative Elements */}
