...
export default function About() {
    const techStack = [
        { name: "TypeScript", color: "#3178C6", path: "M3.7 3.7h16.6v16.6H3.7zM14 15h1.5v-3.5h1.2v-1.2h-3.9v1.2h1.2zm-2.8 0h1.5v-1.1c0-.4 0-.7-.3-.8-.3-.2-.7-.1-.9.1v-1.2c.5-.3 1.2-.4 1.8-.1.8.3 1.1 1 1.7v2.9h-1.5v-.5c-.3.4-.8.6-1.3.6-.9 0-1.5-.6-1.5-1.5 0-1 .7-1.5 1.8-1.5h1.4v-.2c0-.4-.2-.6-.7-.6-.4 0-.8.1-1.2.3v1.1z" },
        ...
        { name: "PostgreSQL", color: "#336791", path: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8 8-8 8zm-1-5h2v-3h3v-2h-3V7h-2v3H8v2h3z" },
